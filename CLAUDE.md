...
│                          # decline wrappers). src/recurring/ (Phase 25 — SeriesForm.tsx,
...
│                          # button per row for any booking with a series_id. src/waitlist/
...
│                          # opaque-busy-cell path into JoinWaitlistPanel. Tailwind v4
│                          # (CSS-first @theme). Vitest + React Testing Library
│                          # (src/api/client.test.ts — idempotency-key reuse, 503 retry,
│                          # error.code branching; src/booking/*.test.ts(x) — Phase 24/26,
...
│                          # JoinWaitlistPanel/MyWaitlistPage — all unit-tested directly)
...
entry point from any full calendar slot.
...
Full frontend suite: 79 tests (65 + 14 new), no regressions, plus
