...
│                          # cancel wrappers). src/recurring/ (Phase 25 — SeriesForm.tsx,
...
│                          # button per row for any booking with a series_id. Tailwind v4
│                          # (CSS-first @theme). Vitest + React Testing Library
│                          # (src/api/client.test.ts — idempotency-key reuse, 503 retry,
│                          # error.code branching; src/booking/*.test.ts(x) — Phase 24,
│                          # dateGrid/timezone/conflicts/CalendarPage; src/recurring/*.test.tsx
│                          # — Phase 25, PreviewPanel/ConfirmResult/RecurringSeriesPage — all
