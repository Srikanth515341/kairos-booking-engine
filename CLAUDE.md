...
│                          # Bookings need). Tailwind v4 (CSS-first @theme). Vitest + React
│                          # Testing Library (src/api/client.test.ts — idempotency-key reuse,
│                          # 503 retry, error.code branching; src/booking/*.test.ts(x) — Phase
│                          # 24, dateGrid/timezone/conflicts/CalendarPage, all unit-tested
│                          # directly)
...
create, conflict handling, cancel/edit, My Bookings) on top of it.
